...
export function Button({ children, classes, ...props }: ButtonProps) {
  ...
  return (
    ...
    >
      ...
      <span className="absolute inset-0 rounded-xl bg-gradient-to-l from-[#470013] via-[#940029] to-[#470013]"></span>
      <span className="duration-600 relative block -translate-y-1 rounded-xl bg-[#f01d56] px-5 py-1 text-white transition-transform ease-[cubic-bezier(.3,.7,.4,1)] will-change-transform hover:-translate-y-1.5 active:-translate-y-0.5 md:px-4">
        {children}
      </span>
    </button>
  );
...
export function CircleButton({ children, classes, ...props }: ButtonProps) {
  ...
  return (
    ...
    >
      ...
      <span className="absolute inset-0 rounded-full bg-gradient-to-l from-[#470013] via-[#940029] to-[#470013]"></span>
      <span className="duration-600 relative flex h-full w-full -translate-y-1 items-center justify-center rounded-full bg-[#f01d56] text-lg text-white transition-transform ease-[cubic-bezier(.3,.7,.4,1)] will-change-transform hover:-translate-y-1.5 active:-translate-y-0.5 md:text-lg">
        {children}
      </span>
    </button>
  );
